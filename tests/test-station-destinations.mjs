...
// arrived, every time.
//
// BravoTwo was watched doing it: in the hall at r15c24, and back in Blackstone Keep at
...
test('station: but the APPROACH is still recallable, or the way home is stranded', () => {
  ...
  // because its errand has ended and nothing recalls it. Echo was found holding 128
